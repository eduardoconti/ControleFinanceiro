...
import { retornaTotalDespesasPagas, retornaTotalDespesasAbertas } from './DepesaFuncoes'
import { retornaTotalReceitasPagas, retornaTotalReceitasAbertas } from './ReceitaFuncoes'
...
async function calculaTotais( stateCheckedDespesas, stateCheckedReceitas ) {
    ...
    return {
        ...
        balanco: (totalReceitasAbertas + totalReceitasPagas) - (totalDespesasPagas + totalDespesasAbertas)
    }
